...
a = Analysis([str(tools/'FQ4SaveEditor'/'app.py')], pathex=[str(tools/'scripts')],
    binaries=[], datas=[(str(tools/'FQ4SaveEditor'/'character_names.json'),'.'),(str(tools/'FQ4SaveEditor'/'class_names.json'),'.'),(str(tools/'FQ4SaveEditor'/'class_catalog.json'),'.'),(str(tools/'FQ4SaveEditor'/'item_names.json'),'.'),(str(tools/'FQ4SaveEditor'/'spell_names.json'),'.'),(str(tools/'FQ4SaveEditor'/'class_icons'),'class_icons'),(str(tools/'scripts'/'fq4_memcard.py'),'scripts')],
